...
class cusuarios_list extends cusuarios {
	...
	function GetFilterList() {
		...
		// Initialize
		$sFilterList = "";
		$sFilterList = ew_Concat($sFilterList, $this->iduser->AdvancedSearch->ToJSON(), ","); // Field iduser
		$sFilterList = ew_Concat($sFilterList, $this->_email->AdvancedSearch->ToJSON(), ","); // Field email
		$sFilterList = ew_Concat($sFilterList, $this->senha->AdvancedSearch->ToJSON(), ","); // Field senha
		$sFilterList = ew_Concat($sFilterList, $this->priv->AdvancedSearch->ToJSON(), ","); // Field priv
		$sFilterList = ew_Concat($sFilterList, $this->sess->AdvancedSearch->ToJSON(), ","); // Field sess
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field priv
		$this->priv->AdvancedSearch->SearchValue = @$filter["x_priv"];
		$this->priv->AdvancedSearch->SearchOperator = @$filter["z_priv"];
		$this->priv->AdvancedSearch->SearchCondition = @$filter["v_priv"];
		$this->priv->AdvancedSearch->SearchValue2 = @$filter["y_priv"];
		$this->priv->AdvancedSearch->SearchOperator2 = @$filter["w_priv"];
		$this->priv->AdvancedSearch->Save();

		// Field sess
		$this->sess->AdvancedSearch->SearchValue = @$filter["x_sess"];
		$this->sess->AdvancedSearch->SearchOperator = @$filter["z_sess"];
		$this->sess->AdvancedSearch->SearchCondition = @$filter["v_sess"];
		$this->sess->AdvancedSearch->SearchValue2 = @$filter["y_sess"];
		$this->sess->AdvancedSearch->SearchOperator2 = @$filter["w_sess"];
		$this->sess->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->senha, $arKeywords, $type);
		$this->BuildBasicSearchSQL($sWhere, $this->sess, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->iduser, $bCtrl); // iduser
			$this->UpdateSort($this->_email, $bCtrl); // email
			$this->UpdateSort($this->senha, $bCtrl); // senha
			$this->UpdateSort($this->priv, $bCtrl); // priv
	...
	function RenderListOptions() {
		...
		$oListOpt->Body = "<input type=\"checkbox\" name=\"key_m[]\" value=\"" . ew_HtmlEncode($this->iduser->CurrentValue) . "\">";
...
fusuarioslist.Lists["x_priv"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioslist.Lists["x_priv"].Options = <?php echo json_encode($usuarios->priv->Options()) ?>;
...
<div class="ewNumericPage"><ul class="pagination">
	...
	<li><a href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->FirstButton->Start ?>"><?php echo $Language->Phrase("PagerFirst") ?></a></li>
	<?php } ?>
	<?php if ($usuarios_list->Pager->PrevButton->Enabled) { ?>
	<li><a href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->PrevButton->Start ?>"><?php echo $Language->Phrase("PagerPrevious") ?></a></li>
	<?php } ?>
	<?php foreach ($usuarios_list->Pager->Items as $PagerItem) { ?>
		<li<?php if (!$PagerItem->Enabled) { echo " class=\" active\""; } ?>><a href="<?php if ($PagerItem->Enabled) { echo $usuarios_list->PageUrl() . "start=" . $PagerItem->Start; } else { echo "#"; } ?>"><?php echo $PagerItem->Text ?></a></li>
	<?php } ?>
	<?php if ($usuarios_list->Pager->NextButton->Enabled) { ?>
	<li><a href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->NextButton->Start ?>"><?php echo $Language->Phrase("PagerNext") ?></a></li>
	<?php } ?>
	<?php if ($usuarios_list->Pager->LastButton->Enabled) { ?>
	<li><a href="<?php echo $usuarios_list->PageUrl() ?>start=<?php echo $usuarios_list->Pager->LastButton->Start ?>"><?php echo $Language->Phrase("PagerLast") ?></a></li>
	<?php } ?>
</ul></div>
</div>
...
<form name="fusuarioslist" id="fusuarioslist" class="form-horizontal ewForm ewListForm ewMultiColumnForm" action="<?php echo ew_CurrentPage() ?>" method="post">
...
?>
<?php echo $usuarios_list->MultiColumnBeginGrid() ?>
<div class="<?php echo $usuarios_list->MultiColumnClass ?>"<?php echo $usuarios->RowAttributes() ?>>
	...
	<?php if ($usuarios->iduser->Visible) { // iduser ?>
		<?php if ($usuarios->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="usuarios_iduser">
<?php if ($usuarios->Export <> "" || $usuarios->SortUrl($usuarios->iduser) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $usuarios->iduser->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->iduser) ?>',2);">
            	<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->iduser->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->iduser->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->iduser->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
				</div>
<?php } ?>
			</span></td>
			<td<?php echo $usuarios->iduser->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_iduser">
...
<?php echo $usuarios->iduser->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group usuarios_iduser">
			<label class="col-sm-2 control-label ewLabel"><?php echo $usuarios->iduser->FldCaption() ?></label>
...
<?php echo $usuarios->iduser->ListViewValue() ?></span>
	...
	<?php if ($usuarios->_email->Visible) { // email ?>
		<?php if ($usuarios->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="usuarios__email">
<?php if ($usuarios->Export <> "" || $usuarios->SortUrl($usuarios->_email) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $usuarios->_email->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->_email) ?>',2);">
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios__email">
...
<?php echo $usuarios->_email->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group usuarios__email">
			<label class="col-sm-2 control-label ewLabel"><?php echo $usuarios->_email->FldCaption() ?></label>
...
<?php echo $usuarios->_email->ListViewValue() ?></span>
	...
	<?php if ($usuarios->senha->Visible) { // senha ?>
		<?php if ($usuarios->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="usuarios_senha">
<?php if ($usuarios->Export <> "" || $usuarios->SortUrl($usuarios->senha) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $usuarios->senha->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->senha) ?>',2);">
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_senha">
...
<?php echo $usuarios->senha->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group usuarios_senha">
			<label class="col-sm-2 control-label ewLabel"><?php echo $usuarios->senha->FldCaption() ?></label>
...
<?php echo $usuarios->senha->ListViewValue() ?></span>
	...
	<?php if ($usuarios->priv->Visible) { // priv ?>
		<?php if ($usuarios->RowType == EW_ROWTYPE_VIEW) { // View record ?>
		<tr>
			<td class="ewTableHeader"><span class="usuarios_priv">
<?php if ($usuarios->Export <> "" || $usuarios->SortUrl($usuarios->priv) == "") { ?>
				<div class="ewTableHeaderCaption"><?php echo $usuarios->priv->FldCaption() ?></div>
<?php } else { ?>
				<div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->priv) ?>',2);">
            	<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->priv->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->priv->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->priv->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
				</div>
<?php } ?>
			</span></td>
			<td<?php echo $usuarios->priv->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_priv">
...
<?php echo $usuarios->priv->ListViewValue() ?></span>
		...
		<?php } else { // Add/edit record ?>
		<div class="form-group usuarios_priv">
			<label class="col-sm-2 control-label ewLabel"><?php echo $usuarios->priv->FldCaption() ?></label>
...
$usuarios_list->ListOptions->Render("body", "", $usuarios_list->RowCnt);
?>
</div>
<div class="clearfix"></div>
</div>
...
?>
<?php echo $usuarios_list->MultiColumnEndGrid() ?>
<div class="clearfix"></div>
<?php } ?>
