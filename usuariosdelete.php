...
fusuariosdelete.Lists["x_priv"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuariosdelete.Lists["x_priv"].Options = <?php echo json_encode($usuarios->priv->Options()) ?>;
...
<?php if ($usuarios->iduser->Visible) { // iduser ?>
		<th><span id="elh_usuarios_iduser" class="usuarios_iduser"><?php echo $usuarios->iduser->FldCaption() ?></span></th>
<?php } ?>
...
<?php if ($usuarios->priv->Visible) { // priv ?>
		<th><span id="elh_usuarios_priv" class="usuarios_priv"><?php echo $usuarios->priv->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($usuarios->iduser->Visible) { // iduser ?>
		<td<?php echo $usuarios->iduser->CellAttributes() ?>>
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_iduser" class="usuarios_iduser">
<span<?php echo $usuarios->iduser->ViewAttributes() ?>>
<?php echo $usuarios->iduser->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($usuarios->_email->Visible) { // email ?>
...
<?php } ?>
<?php if ($usuarios->priv->Visible) { // priv ?>
		<td<?php echo $usuarios->priv->CellAttributes() ?>>
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_priv" class="usuarios_priv">
<span<?php echo $usuarios->priv->ViewAttributes() ?>>
<?php echo $usuarios->priv->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
