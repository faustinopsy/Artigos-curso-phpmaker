...
define("EW_PROJECT_NAME", "artigos", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{62B16F30-7B01-4FF2-AFCB-D258EDB35A44}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '4M2qcWamqMVMILXg', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/artigos.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "usbw", "db" => "artigos", "qs" => "`", "qe" => "`");
...
$EW_LANGUAGE_FILE[] = array("br", "", "portugues.xml");
define("EW_LANGUAGE_DEFAULT_ID", "br", TRUE);
...
define("EW_USER_ID_FILTER", "(`iduser` = %u)", TRUE);
...
define("EW_UPLOAD_DEST_PATH", "/temp/", TRUE); // Upload destination path (relative to app root)
