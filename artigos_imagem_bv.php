...
$artigos_imagem_blobview = NULL; // Initialize page object first

class cartigos_imagem_blobview extends cartigos {
	...
	// Page object name
	var $PageObjName = 'artigos_imagem_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'artigos');
	...
	function Page_Main() {
		...
		// SQL constructor in artigos class, artigosinfo.php
...
// Create page object
if (!isset($artigos_imagem_blobview)) $artigos_imagem_blobview = new cartigos_imagem_blobview();

// Page init
$artigos_imagem_blobview->Page_Init();

// Page main
$artigos_imagem_blobview->Page_Main();
?>
<?php
$artigos_imagem_blobview->Page_Terminate();
?>
