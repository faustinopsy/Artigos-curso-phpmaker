...
$edicao_imagem_blobview = NULL; // Initialize page object first

class cedicao_imagem_blobview extends cedicao {
	...
	// Page object name
	var $PageObjName = 'edicao_imagem_blobview';
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel(CurrentProjectID() . 'edicao');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('edicao', 'x_imagem');
...
// Create page object
if (!isset($edicao_imagem_blobview)) $edicao_imagem_blobview = new cedicao_imagem_blobview();

// Page init
$edicao_imagem_blobview->Page_Init();

// Page main
$edicao_imagem_blobview->Page_Main();
?>
<?php
$edicao_imagem_blobview->Page_Terminate();
?>
